-- Migration 010: refresh app_price_index with B2C sanity filtering.
-- Re-run this after 009 if app_price_index was created before the B2C floor
-- rule landed. B2C prices below 50% of a reliable C2C median are excluded from
-- app-facing lowest-price cards.
...
comment on view app_price_index is
  'Read-only app price index combining C2C used stats, B2C snapshots, new price, C2B offer anchor, and B2C sanity filtering.';
